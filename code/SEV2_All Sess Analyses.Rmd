...
Training.df<- read_excel("data/SEV_v2_-_Training_-_Raw_Data.xlsx", sheet = 4) %>%
  bind_rows(read_excel("data/SEV_v2_-_Training_refresher_for_sess_2_-_Raw_Data.xlsx", sheet = 4)) %>%
  transmute(SubjectCode = `Participant Code`,
            SampleName = `Sample Name`,
            T1Rating = `Please mark the perceived intensity of {{sample_name}} exactly as you recorded it on your paper sheet.`,
            T2Rating = `Please mark the perceived intensity of {{sample_name}}.`) 
